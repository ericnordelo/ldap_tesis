\begin{conclusions}
    ...
    Esta solución ha sido implementada de manera que sea fácilmente despegable y modificable. Gracias al uso de la tecnología Docker el despliegue requiere una configuración manual mínima, así como ninguna dependencia en la computadora final en la que se publique el sistema como servicio (exceptuando Docker por supuesto). Además, el uso de lenguajes dinámicos (como lo son Python y Javascript), disminuye el riesgo de la pérdida del código fuente, ya que la aplicación en producción no es un archibo binario ilegible, sino el código en si.
