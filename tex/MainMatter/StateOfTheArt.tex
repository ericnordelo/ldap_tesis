...
\todo[inline]{Se necesita una introduccion al capitulo mejor que la que tienes arriba. LDAP tiene poco que ver con el grueso de tu tesis, mas alla de ser la fuente en la que persistir tus datos. }
...
\todo[inline]{Nuevamente, nada que seleccionar ... ya alguien selecciono por ti. }

\todo[inline]{En este capitulo debes comenzar la introducci'on debatiendo entre las posibles alternativas para implementar la propuesta que diste al final de capitulo anterior e irlas tratando por secciones. En el caso de ldap solo seria explicar en que consiste el protocolo y tocar cuales son los mecanismos utilizados para salvar datos, LDIF, pythonLDAP (ojo para ello debes haber hablado de la herramienta/lenguaje para implementar el api antes)}
...
\todo[inline]{No es objetivo del capitulo de estado del arte analizar a los que usan docker ... a lo sumo mecionar, pero no analizar.}
...
\todo[inline]{Todas estas urls ponlas como referencias.}
