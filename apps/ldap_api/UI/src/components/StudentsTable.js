...
class StudentsTable extends Component {
  ...
  handleSelectAllClick = event => {
    if (event.target.checked) {
      this.setState(state => ({ selected: this.props.students.map(n => n.id) }));
      return;
    }
  ...
  render() {
    ...
    const emptyRows = rowsPerPage - Math.min(rowsPerPage, this.props.students.length - page * rowsPerPage);
      ...
      <Paper className={classes.root}>
        ...
        <div className={classes.tableWrapper}>
          <Table className={classes.table} aria-labelledby="tableTitle">
            ...
            />
            <TableBody>
              {stableSort(this.props.students, getSorting(order, orderBy))
        ...
        <TablePagination
          ...
          component="div"
          count={this.props.students.length}
