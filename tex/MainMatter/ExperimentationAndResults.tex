...
\section{Conceptos Importantes dentro de LDAP}

\subsection{Servidor de Directorio}
...
\subsection{Nombre Distinguido (DN)} 
...
\verb|1.3.6.1.4.1.<Identificador global>.1.5|
...
configuraciones como los datos almacenados en el servidor LDAP. De la línea de código 1 a la 3, 
...
El identificador global, como se puede ver en el listado, no es más que un número de serie 
...
\section{Implementaciones más utilizadas}
\subsection{IBM Security Directory Server}
...
de soportarlo.
\subsection{Oracle Internet Directory}
...
\section{Modos de empleo usuales}
\subsection{DNS}
