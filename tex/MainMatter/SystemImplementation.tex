...
\section{Estracción de la información de estudiantes y trabajadores}

Como mencionamos antes, de la estracción de la información se encargan dos módulos independientes desarrollados en Python, los cuáles consumen la información de Recursos Humanos de los destinos correspondientes y generan archivos LDIF que utiliza el servidor LDAP para modificar los datos almacenados. Estos módulos son:
