...
Tener una API como intermediaria entre el servidor LDAP, las demás fuentes de información (SIGENU y Bases de Datos de trabajadores) y los mecanismos de gestión de información (interfaces visuales para manejo de externos, cuotas, etc...), permite manipular los diversos componentes del Directorio Único utilizando un lenguaje común muy estandarizado (protocolo HTTP en este caso), permitiendo a los distintos clientes consumidores de la información de directorio abstraerse comunicarse mediante el protocolo LDAP (menos estandarizado). Además permite que al modificarse la estructura del Directorio, los clientes no tengan que ser modificados, ya que al modificar solamente la API como capa intermedia podemos cambiar la forma de obtener información de las fuentes mientras mantenemos la estructura a la hora de publicar la información. 
...
ASP.NET es un framework web de código abierto implementado por Microsoft, para desarrollar aplicaciones web dinámicas utlizando C Sharp o Visual Basic como lenguaje de programación. Entre sus principales ventajas está la facilidad de integración con programas y servicios de Microsoft y Windows.

\subsubsection{Ruby on Rails}

Este es un framework web de código abierto con una de las comunidades de desarrolladores más grandes. Esta implementado sobre el lenguage Ruby. Entre sus principales ventajas está que es un framework sobre un lenguaje dinámico (esto es una ventaja para la velocidad de implementación) y que consta de una enorme cantidad de gemas (soluciones ya implementadas a muchos problemas de diversos tipos) gracias a su gran comunidad.

\subsubsection{Django y Flask}

Estos son dos frameworks implementados sobre el lenguaje de programación Python (lenguaje dinámico al igual que Ruby). Su principal diferencia es que Django es un framework monolítico que integra una gran cantidad de funcionalidades y patrones, mientras que Flask es un framework minimalista extensible en el cual los distintos módulos deben ser integrados o implementados por los desarrolladores (módulo de autenticación, etc...). Al ser frameworks web de Python, tienen como ventaja la posibilidad de usar de manera directa todas las librarías existentes para este lenguaje de programación.
